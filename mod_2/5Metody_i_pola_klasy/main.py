...
def run_homework():
    ...
    cookies_tax = TaxCalculator.calculate_tax(ten_cookies)
    tomatoes_tax = TaxCalculator.calculate_tax(five_tomatoes)
    something_tax = TaxCalculator.calculate_tax(single_something)
